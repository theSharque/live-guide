...
/**
 * Allows modules to specify a uri for a return.
 *
 * When this hook is invoked, the first returned uri will be used for the return.
 * Thus to override the default value provided by the Return module, you would
 * need to adjust the return of hook invocation via hook_module_implements_alter()
 * or your module weight values.
 *
 * @param CommerceReturn $return
 *   The CommerceReturn object whose uri is being determined.
 *
 * @return array
 *  The uri elements of an entity as expected to be returned by entity_uri()
 *  matching the signature of url().
 *
 * @see commerce_return_uri()
 * @see hook_module_implements_alter()
 * @see entity_uri()
 * @see url()
 */
function hook_commerce_return_uri(CommerceReturn $return) {
  // No example.
}

/**
 * Allows modules to specify a uri for a return reason.
 *
 * When this hook is invoked, the first returned uri will be used for the
 * return reason. Thus to override the default value provided by the Return
 * module, you would need to adjust the return of hook invocation via
 * hook_module_implements_alter() or your module weight values.
 *
 * @param CommerceReturnReason $return_reason
 *   The CommerceReturnReason object whose uri is being determined.
 *
 * @return array
 *  The uri elements of an entity as expected to be returned by entity_uri()
 *  matching the signature of url().
 *
 * @see commerce_return_reason_uri()
 * @see hook_module_implements_alter()
 * @see entity_uri()
 * @see url()
 */
function hook_commerce_return_reasons_uri(CommerceReturnReason $return_reason) {
  // No example.
}