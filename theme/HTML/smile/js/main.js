$(document).ready(function () {
    ...
    //PORDUCT SINGLE
    $("#ps-img1").on("click", function () {
        $('.ps-img1').css('opacity', '1');
        $('.ps-img2').css('opacity', '0');
        $('.ps-img3').css('opacity', '0');
        $('.ps-img4').css('opacity', '0');
    });

    $("#ps-img2").on("click", function () {
        $('.ps-img1').css('opacity', '0');
        $('.ps-img2').css('opacity', '1');
        $('.ps-img3').css('opacity', '0');
        $('.ps-img4').css('opacity', '0');
    });

    $("#ps-img3").on("click", function () {
        $('.ps-img1').css('opacity', '0');
        $('.ps-img2').css('opacity', '0');
        $('.ps-img3').css('opacity', '1');
        $('.ps-img4').css('opacity', '0');
    });

    $("#ps-img4").on("click", function () {
        $('.ps-img1').css('opacity', '0');
        $('.ps-img2').css('opacity', '0');
        $('.ps-img3').css('opacity', '0');
        $('.ps-img4').css('opacity', '1');
    });

    $("#ps-img5").on("click", function () {
        $('.ps-img5').css('opacity', '1');
        $('.ps-img6').css('opacity', '0');
        $('.ps-img7').css('opacity', '0');
        $('.ps-img8').css('opacity', '0');
    });

    $("#ps-img6").on("click", function () {
        $('.ps-img5').css('opacity', '0');
        $('.ps-img6').css('opacity', '1');
        $('.ps-img7').css('opacity', '0');
        $('.ps-img8').css('opacity', '0');
    });

    $("#ps-img7").on("click", function () {
        $('.ps-img5').css('opacity', '0');
        $('.ps-img6').css('opacity', '0');
        $('.ps-img7').css('opacity', '1');
        $('.ps-img8').css('opacity', '0');
    });

    $("#ps-img8").on("click", function () {
        $('.ps-img5').css('opacity', '0');
        $('.ps-img6').css('opacity', '0');
        $('.ps-img7').css('opacity', '0');
        $('.ps-img8').css('opacity', '1');
    });
